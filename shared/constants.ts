...
export const SHIP_PROFILES: Record<ShipProfileId, ShipProfile> = {
  balanced: {
    ...
    lateralGrip: 10.75,
    driftGrip: 3.05,
    turnRate: (138 * Math.PI) / 180,
    strafeForce: scaled(1180),
    boostDrainRate: 0.2,
    railIntegrityDamage: 0.068,
    railSpeedIntegrityDamage: 0.052,
    railGlanceRetention: 0.92,
    railHeavyHitRetention: 0.76,
  ...
  swift: {
    ...
    lateralGrip: 11.85,
    driftGrip: 2.72,
    turnRate: (154 * Math.PI) / 180,
    strafeForce: scaled(1320),
    boostDrainRate: 0.24,
    railIntegrityDamage: 0.078,
    railSpeedIntegrityDamage: 0.066,
    railGlanceRetention: 0.88,
    railHeavyHitRetention: 0.71,
  ...
  heavy: {
    ...
    lateralGrip: 9.45,
    driftGrip: 3.3,
    turnRate: (118 * Math.PI) / 180,
    strafeForce: scaled(950),
    boostDrainRate: 0.16,
    railIntegrityDamage: 0.044,
    railSpeedIntegrityDamage: 0.038,
    railGlanceRetention: 0.95,
    railHeavyHitRetention: 0.84,
...
export const TRACK_LIMITS = {
  ...
  railSlideForwardMinimumScale: 0.9,
  railSlidePinnedForwardMinimumScale: 0.96,
